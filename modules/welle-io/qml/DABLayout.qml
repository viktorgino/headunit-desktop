        ...
        Item {
            ...
            Item {
                ...
                RowLayout {
                    ...
                    Accessible.name: qsTr("Signal noise ratio: " + WelleIoPlugin.RadioController.snr )

                    Rectangle{
                        height: 4
                        width: 4
                        color: (WelleIoPlugin.RadioController.snr > 2) ? "green" : "dimgrey"
                        Accessible.ignored: true
                    }
                    Rectangle{
                        height: 8
                        width: 4
                        color: (WelleIoPlugin.RadioController.snr > 5) ? "green" : "dimgrey"
                        Accessible.ignored: true
                    }
                    Rectangle{
                        height: 12
                        width: 4
                        color: (WelleIoPlugin.RadioController.snr > 8) ? "green" : "dimgrey"
                        Accessible.ignored: true
                    }
                    Rectangle{
                        height: 16
                        width: 4
                        color: (WelleIoPlugin.RadioController.snr > 11) ? "green" : "dimgrey"
                        Accessible.ignored: true
                    }
                    ...
                    Rectangle{
                        height: 20
                        width: 4
                        color: (WelleIoPlugin.RadioController.snr > 15) ? "green" : "dimgrey"
                        Accessible.ignored: true
                    }
                }
                ThemeText {
                ...
                ImageButton {
                    ...
                    onClicked: {
                        if(WelleIoPlugin.RadioController.isPlaying){
                            WelleIoPlugin.RadioController.stop();
                        } else {
                            WelleIoPlugin.playLastStation();
                        }
                    }
                }
            }
