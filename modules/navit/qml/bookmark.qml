...
Item {
    ...
    Text {
        ...
        y: 8
        color: "#ffffff"
        text: NavitGUI.currentBookmark.name
        font.pixelSize: 32
    }
    ...
    Text {
        ...
        y: 64
        color: "#ffffff"
        text: NavitGUI.currentBookmark.type
        font.pixelSize: small_font_size
    }
    ...
    Text {
        ...
        y: 96
        color: "#ffffff"
        text: NavitGUI.currentBookmark.distance
        font.pixelSize: small_font_size
    }
    ...
    Rectangle {
        ...
        Image {
            height: parent.width
            width: parent.height
            source : NavitGUI.get_icon_path() + NavitGUI.currentBookmark.icon
    ...
    MainButton {
        ...
        onClicked: {
            NavitGUI.setCurrentBookmarkAsDestination()
        }
    }
